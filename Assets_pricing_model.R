...
library(readr)
Estados_Unidos_3_meses_Datos_Historicos_Rendimiento_de_Bonos <- read_csv("Estados Unidos 3 meses Datos Historicos Rendimiento de Bonos.csv")
View(Estados_Unidos_3_meses_Datos_Historicos_Rendimiento_de_Bonos)

str(Estados_Unidos_3_meses_Datos_Historicos_Rendimiento_de_Bonos)
US3MTBR<-Estados_Unidos_3_meses_Datos_Historicos_Rendimiento_de_Bonos[,2]
Fecha<-as.Date(Estados_Unidos_3_meses_Datos_Historicos_Rendimiento_de_Bonos$Fecha,"%m/%d/%Y")
...
# 3) L?nea de Mercado de Valores // Security Market Line

plot(D.CAPM.IBM.DF$S.P.500,D.CAPM.IBM.DF$IBM,
     main="Regresion CAPM para IBM",
     ylab="Excedente de retornos en IBM",
     xlab="Excedente de retornos en el MERCADO")
abline(CAPM_IBM,col="red")     # L?nea de la regresi?n
...
plot(D.CAPM.IBM.DF$S.P.500,D.CAPM.IBM.DF$IBM,
     ...
     ylab="Excedente de retornos en IBM",
     xlab="Excedente de retornos en el MERCADO")
abline(SIM_IBM,col="blue")     # L?nea de la regresi?n
abline(h=0,v=0)                 # Se solicita graficar los ejes
...
plot(D.CAPM.IBM.DF$S.P.500,D.CAPM.IBM.DF$IBM,
     ...
     ylab="Excedente de retornos en IBM",
     xlab="Excedente de retornos en el MERCADO")
abline(CAPM_IBM,col="red")     # L?nea de CAPM
abline(SIM_IBM,col="blue")     # L?nea de SIM
abline(h=0,v=0)                 # Se solicita graficar los ejes
